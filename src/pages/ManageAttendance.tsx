...
import { CheckCircle2, XCircle, Clock, ArrowLeft, Users } from "lucide-react";
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        ...
        {eventQuery.data && (
          <div className="mb-8">
            ...
            <p className="text-muted-foreground mt-1">Gestionar asistencia de voluntarios</p>
          </div>
        )}
        ...
        {isCreator && (
          <>
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              ...
              <div className="bg-card border border-border rounded-xl p-4 text-center shadow-card">
                <p className="text-2xl font-bold text-destructive">{noShows}</p>
